...
public class TestActack {
     ...
     * 输入你想攻击的网址
     */
    private static final String URL1 = "http://gateway.hanyuan.vip/hy-sys/app/loginByPhone";
    private static final String URL2 = "http://gateway.hanyuan.vip/hy-sys/app/loginByPhone";
